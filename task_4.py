...
def pdf_to_image(pdf_path, image_path):
    ...
    Args:
        ...
        image_path (str): Directory to save the images.
    """
...
def text_to_document(text_path, doc_path):
    """
    Converts text to a DOCX document.
    
    Args:
        text_path (str): Path to the text file.
        doc_path (str): Path to save the DOCX file.
    """
    document = Document()
...
image_output_path = r"E:/vivek"
text_output_path = r"E:/vivek/textfile.txt"
doc_output_path = r"E:/vivek/document.docx"
